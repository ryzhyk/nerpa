...
"Regular keywords
syn keyword ccnStatement        and bool fork function procedure assume host not or pkt refine send primary table view foreign key check unique references match state drop in out any the var switch port task shard
