...
matchMap = M.fromList 
           ...
           , ("payload.ip4.payload.icmp6.type"                  ,"icmp6_type" )
           , ("payload.ip4.payload.icmp6.code"                  ,"icmp6_code" )
           , ("payload.ip4.payload.icmp6.payload._tag"          ,"icmp6_type" )
           , ("payload.ip4.payload.icmp6.payload.ns.target"     ,"nd_target" )
           , ("payload.ip4.payload.icmp6.payload.na.target"     ,"nd_target" )
           , ("payload.ip4.payload.icmp6.payload.ns.sll"        ,"nd_sll" )
           , ("payload.ip4.payload.icmp6.payload.na.tll"        ,"nd_tll" )
           ...
           , ("payload.ip6.payload.icmp6.type"                  ,"icmp6_type" )
           , ("payload.ip6.payload.icmp6.code"                  ,"icmp6_code" )
           , ("payload.ip6.payload.icmp6.payload._tag"          ,"icmp6_type" )
           , ("payload.ip6.payload.icmp6.payload.ns.target"     ,"nd_target" )
...
assnMap = M.fromList
          ...
          , ("payload.ip4.payload.icmp6.payload._tag"          , ("NXM_OF_ICMP_TYPE"   , Nothing))
          , ("payload.ip4.payload.icmp6.payload.ns.target"     , ("NXM_NX_ND_TARGET"   , Nothing))
          , ("payload.ip4.payload.icmp6.payload.na.target"     , ("NXM_NX_ND_TARGET"   , Nothing))
          , ("payload.ip4.payload.icmp6.payload.ns.sll"        , ("NXM_NX_ND_SLL"      , Nothing))
          , ("payload.ip4.payload.icmp6.payload.na.tll"        , ("NXM_NX_ND_TLL"      , Nothing))
          ...
          , ("payload.ip6.payload.icmp6.payload._tag"          , ("NXM_OF_ICMP_TYPE"   , Nothing))
          , ("payload.ip6.payload.icmp6.payload.ns.target"     , ("NXM_NX_ND_TARGET"   , Nothing))
