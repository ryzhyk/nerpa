...
exprNodeType' _ _   (EFork _ _ _ _ _ b)    = b
exprNodeType' _ _   (EFor  _ _ _ _ _)      = Just $ tTuple []
exprNodeType' _ _   (EWith _ _ _ _ _ b _)  = b
exprNodeType' _ _   (EAny  _ _ _ _ _ b _)  = b
...
ctxExpectType _ (CtxForkShard _ _)                   = Just tBool
...
ctxExpectType _ (CtxWithShard _ _)                   = Just tBool
...
ctxExpectType _ (CtxAnyShard _ _)                    = Just tBool
